<x-filament-panels::page>
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('reporte.ingresos.pdf', ['year' => request('year', now()->year)]) }}" class="px-4 py-2 text-white" style="background-color: #4CAF50;">Generar PDF</a>
    </div>

    <!-- Tabla para mostrar los ingresos agrupados por mes -->
    @if ($ingresos->isEmpty())
